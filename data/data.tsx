  ...
  reviews: [
    {
      ...
      description: (
        <>Чудесное место. Новая база всё чистенько окуратно, в&nbsp;отделении от&nbsp;дороги, рублёвки поэтому тихо и&nbsp;спокойно, владелец Михаил сам бывший турист посоветует куда в&nbsp;какой сезон стоит ехать. В&nbsp;номерах есть душ, туалет. На&nbsp;территории басейн, кухня, монгальная зона и&nbsp;костровая зона. Встречает и&nbsp;провожает красавица Луна. Ели не&nbsp;хотите готовить в&nbsp;5&nbsp;минутах ходьбы есть кафе Вдох.
        Всём советую. А&nbsp;Михаилу процветания его горной далины.</>
      ),
    ...
    },
    {
      ...
      description: (
        <>Очень уютная база с&nbsp;замечательным персоналом. На&nbsp;территории есть все что нужно для отдыха и&nbsp;приготовления пищи. Отличный бассейн. Не&nbsp;хватает баньки но&nbsp;думаю в&nbsp;ближайшем будущем поставят. Ах&nbsp;да, шикарный вид из&nbsp;окна номера:)
        Удачи Вам в&nbsp;развитии! Приедем еще не&nbsp;раз.</>
      ),
    ...
    },
    {
      name: 'Марина Ликтей',
      description: (
        <>Отличное расположение базы, новые , уютные и&nbsp;чистенькие домики, в&nbsp;которых ещё пахнет деревом🤤 все удобства : фен, ванные принадлежности, даже белые халаты и&nbsp;тапочки как в&nbsp;отеле☺️🤌🏻
        Мангальная зона и&nbsp;кухня со&nbsp;всем необходимым , всё сделано с&nbsp;душой и&nbsp;это чувствуется .
        Желаем Михаилу и&nbsp;Ирине процветания базы, отличных туристов 🏔</>
      ),
      date: '4 мая 2023'
    },
    {
